...
//
// Package types contains shared types for the OTS module.
// This package has no dependencies on other OTS subpackages to prevent circular imports.
...
type Attempt struct {
	...
	// ConfirmedAt is when BTC confirmation was detected
...
type CandidateBatch struct {
	...
	*BatchMeta
	...
	// EventRUIDs is the list of RUIDs (may be re-defined for clarity)
	EventRUIDs []common.Hash
	...
	// OTSTimestamp is the BTC/OTS block timestamp
	OTSTimestamp uint64

	// BTCTimestamp is an alias for OTSTimestamp (for backward compatibility)
	BTCTimestamp uint64
